...
insert  into `product` values (1, true,'LG Phone','Huawie',100,3), (2, true,'Honer Phone','Houner',100,3) , (3,true ,'Alkater phone','Alkater',150,3), (4,true ,'Alkater phone','Alkater',50,4);
